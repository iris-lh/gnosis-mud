    ...
    listeners: {
      hit: state => function (damage, target) {
        ...
        if (Random.probability(50)) {
          ...
          Broadcast.sayAt(damage.attacker, `<b><white>The Blade of Gnosis shines with a bright white light and you see wisps of ${target.name}'s soul flow into the blade.</white></b>`, 80);
